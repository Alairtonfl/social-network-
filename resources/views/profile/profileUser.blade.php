...
@section('content')
    <div class="container card">
         <h3 class="mx-auto">{{$user->name}}</h3>
        <img src="{{$user->avatar}}" class="mx-auto d-block" alt="Avatar" style="border-radius: 50%; width: 150px;">
    </div>
        ...
        <div class="container card mt-1 mb-3" style="border: 1px solid #000000;">
            ...
            <div>
                ...
                <h6 class="text-primary d-inline">
                    <b>
                        <a href="{{Route('post.profile' , $post->user->id)}}"> Autor: {{$post->user->name}}</a>
                    </b>
                    </h6>
            </div>
            <h4>{{$post->body}}</h4>
                ...
                <div class="container card mt-3">
                    ...
                    @endif
                            <h4 class="text-primary"> 
                                <a href="{{ route('post.profile', $comment->user->id)}}"> <b> {{$comment->user->name}} </b></a>
